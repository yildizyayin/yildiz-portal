...
export const ROLE_DEFAULTS: Record<string, string[]> = {
  SUPER_ADMIN: ALL,
  ADMIN: ALL.filter(x => !['DIGITAL_MANAGE','ORDERS_DELETE'].includes(x)),
  PERSONEL: ['CATALOG_VIEW','DIGITAL_VIEW','INSTITUTIONS_VIEW','OPPORTUNITIES_VIEW','ORDERS_VIEW','ORDERS_CREATE','ORDERS_EDIT','PUBLISHERS_VIEW','REPORTS_VIEW','TASKS_VIEW'],
  OPERASYON: ['CATALOG_VIEW','DIGITAL_VIEW','ORDERS_VIEW','PUBLISHERS_VIEW','OPERATIONS_VIEW','OPERATIONS_MANAGE','TASKS_VIEW'],
  KURUM: ['CATALOG_VIEW','DIGITAL_VIEW','INSTITUTIONS_VIEW','ORDERS_VIEW','ORDERS_CREATE','ORDERS_EDIT']
};
